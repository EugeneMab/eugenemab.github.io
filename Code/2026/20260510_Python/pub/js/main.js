...
async function compileAndRun() {
    ...
    try {
        ...
        try {
            ...
            let phase = "Lexing";
            if (astOutput.textContent === "")
                phase = "Lexing";
            else if (watOutput.textContent === "")
                phase = "Parsing";
            else if (wasmOutput.textContent === "")
                phase = "WASM";
            else
                phase = "Execution";
            ...
            if (match) {
                ...
                const highlightedLine = errorLineText.substring(0, c - 1) + "####" + errorLineText.substring(c - 1);
